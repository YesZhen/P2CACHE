...
df = pd.read_csv("share/output/meta_with_fsync.csv", delimiter = ",", encoding='utf8')
...
ax.set_yticks([0.001, 0.005, 0.01, 0.05, 0.1 , 0.2, 0.5, 1, 5], ["0.001", "0.005", "0.01", "0.05", "0.1", "0.2", "0.5", "1", ""])
fig.tight_layout(pad =0)
foo_fig = plt.gcf() # 'get current figure'
foo_fig.savefig('share/output/meta_with_fsync.png',bbox_inches='tight', format='png', dpi=1000,pad_inches=0.0)