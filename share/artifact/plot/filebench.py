...
df = pd.read_csv("share/output/filebench.csv", delimiter = ",", encoding='utf8')
...
xaxis = ["Fileserver", "Webproxy", "Varmail"]
...
ax.set_yticks([0.03, 0.05, 0.1, 0.2, 0.4, 1], ["0.03", "0.05", "0.1", "0.2", "0.4", "1"])
...
foo_fig.savefig('share/output/filebench.png',bbox_inches='tight', format='png', dpi=1000,pad_inches=0.0)