...
sudo apt-get install -y ipmctl ndctl libtool m4 automake bison byacc flex tree python2 python3 python3-pip xfsprogs fio jq libsnappy-dev libgflags-dev net-tools zstd
